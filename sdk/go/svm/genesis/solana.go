...
import (
	...
	"example.com/pulumi-svm/sdk/go/svm/solana"
...
func NewSolana(ctx *pulumi.Context,
	...
	var resource Solana
	err := ctx.RegisterResource("svm:genesis:Solana", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSolana(ctx *pulumi.Context,
	...
	var resource Solana
	err := ctx.ReadResource("svm:genesis:Solana", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
