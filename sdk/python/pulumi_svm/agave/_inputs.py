...
class ValidatorFlagsArgs:
    def __init__(__self__, *,
                 ...
                 entry_point: pulumi.Input[Sequence[pulumi.Input[str]]],
                 expected_genesis_hash: pulumi.Input[str],
                 full_rpc_api: pulumi.Input[bool],
                 full_snapshot_interval_slots: pulumi.Input[int],
                 gossip_port: pulumi.Input[int],
                 known_validator: pulumi.Input[Sequence[pulumi.Input[str]]],
                 limit_ledger_size: pulumi.Input[int],
                 no_voting: pulumi.Input[bool],
                 ...
                 tvu_receive_threads: pulumi.Input[int],
    ...
    def entry_point(self) -> pulumi.Input[Sequence[pulumi.Input[str]]]:
        return pulumi.get(self, "entry_point")

    @entry_point.setter
    def entry_point(self, value: pulumi.Input[Sequence[pulumi.Input[str]]]):
        pulumi.set(self, "entry_point", value)

    @property
    @pulumi.getter(name="expectedGenesisHash")
    def expected_genesis_hash(self) -> pulumi.Input[str]:
        return pulumi.get(self, "expected_genesis_hash")

    @expected_genesis_hash.setter
    def expected_genesis_hash(self, value: pulumi.Input[str]):
        pulumi.set(self, "expected_genesis_hash", value)

    @property
    @pulumi.getter(name="fullRpcAPI")
    def full_rpc_api(self) -> pulumi.Input[bool]:
        return pulumi.get(self, "full_rpc_api")

    @full_rpc_api.setter
    def full_rpc_api(self, value: pulumi.Input[bool]):
    ...
    def known_validator(self) -> pulumi.Input[Sequence[pulumi.Input[str]]]:
        return pulumi.get(self, "known_validator")

    @known_validator.setter
    def known_validator(self, value: pulumi.Input[Sequence[pulumi.Input[str]]]):
    ...
    def no_voting(self) -> pulumi.Input[bool]:
        return pulumi.get(self, "no_voting")

    @no_voting.setter
    def no_voting(self, value: pulumi.Input[bool]):
    ...
    def tvu_receive_threads(self) -> pulumi.Input[int]:
        return pulumi.get(self, "tvu_receive_threads")

    @tvu_receive_threads.setter
    def tvu_receive_threads(self, value: pulumi.Input[int]):
