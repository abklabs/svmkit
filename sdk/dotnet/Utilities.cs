...
namespace Pulumi.Svm
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Svm.version.txt");
    ...
    internal sealed class SvmResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public SvmResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
